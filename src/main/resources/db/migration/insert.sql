...
VALUES (1, 1, 'Джордж Р. Р. Мартин', 'Песнь Льда и Пламени', 3, '13-08-2000', '13-08-2050'),
       (2, 2, 'Дж. К. Роулинг', 'Гарри Поттер', 1, '29-01-1890', '31-07-1965'),
       (3, 3, 'Лев Толстой', 'Анна Каренина', 2, '28-08-1928','19-08-1937'),
       (4, 2, 'Эдгар Аллан По', 'Ворон',3, '11-11-1821', '07-10-1849'),
       (5, 4, 'Данте Алигьери', 'Божественная комедия', 2, '21-05-1265', '13-09-1321'),
       (6, 5, 'Филип К. Дик', 'Бегущий по лезвию', 1, '16-12-1928', '02-03-1982'),
       (7, 6, 'Марк Твен', 'Приключения Тома Сойера', 3, '30-11-1835', '21-04-1910'),
       (8, 1, 'Антуан де Сент-Экзюпери', 'Маленький принц', 2, '29-06-1900', '31-07-1944'),
       (9, 5, 'Джек Лондон', 'Зов предков', 1,  '12-01-1876', '22-11-1916'),
       (10, 6, 'Михаил Булгаков', 'Мастер и Маргарита', 2, '15-05-1891', '10-03-1940');
